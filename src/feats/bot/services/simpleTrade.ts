...
import model from '../models/simpleTrade'
import { Request, Response } from "express";

class SimpleTradeService {
  static instance: SimpleTradeService
  constructor(){
  }

  public static getInstance() {
    if(!this.instance)
      this.instance = new SimpleTradeService()
...
export  default SimpleTradeService.getInstance()